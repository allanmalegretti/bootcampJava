...
public class TransacaoController {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<TransacaoDto> remover(@PathVariable @RequestBody @NotNull Long id, @ApiIgnore @AuthenticationPrincipal Usuario logado) {
...
//		return ResponseEntity.ok();
	...
	@GetMapping("/{id}")
	public ResponseEntity<TransacaoDetalhadaDto> detalhar(@PathVariable @RequestBody @NotNull Long id, @ApiIgnore @AuthenticationPrincipal Usuario logado) {
